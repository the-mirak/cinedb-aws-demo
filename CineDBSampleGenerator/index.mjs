...
const movies = [
  {
    ...
    rating: 7.8,
    poster: "https://cinedb-bucket-2025.s3.us-east-1.amazonaws.com/ShadowOfTheDeep.png"
  },
  {
    ...
    rating: 9.3,
    poster: "https://cinedb-bucket-2025.s3.us-east-1.amazonaws.com/CelestialNomads.png"
  },
  {
    title: "Quantum Echo",
    ...
    rating: 8.0,
    poster: "https://cinedb-bucket-2025.s3.us-east-1.amazonaws.com/QuantumEcho.png"
  }
];
...
export const handler = async (event, context) => {
  console.log('Starting to add dummy V2 movies...');
  ...
  return {
    statusCode: 200,
    body: JSON.stringify({ message: `Successfully added ${successCount} movies to CineDB-Prod.` }),
  };
};
